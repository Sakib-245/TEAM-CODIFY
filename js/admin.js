    ...
    const reportedEvents = [
        {
            ...
            detailsPage: "Event-card-click(2).html" // Path to specific page
        },
        {
            id: 2,
            title: "Summer Jazz Festival",
            category: "Other",
            organizer: "JJ Organisation",
            ...
            detailsPage: "Event-card-click(1).html" // Path to specific page
        },
        {
            id: 3,
            ...
            image: "../assets/images/Political.jpeg",
            detailsPage: "Event-card-click(3).html" // Path to specific page 
        },
        {
            id: 4,
            ...
            image: "../assets/images/Startup-Companies-in-Pune.jpg",
            detailsPage: "Event-card-click(4).html" // Path to specific page
        }
    ];
    ...
    return `
        <div class="event-card" data-id="${event.id}">
            <div class="card-image">
                <img src="${event.image}" alt="${event.title}" onerror="this.src='https://placehold.co/400x200'">
            ...
            <div class="card-content">
                ...
                <div class="card-actions">
                    <a href="${event.detailsPage}" class="view-btn">View Details</a>
