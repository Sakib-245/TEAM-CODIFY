            ...
            card.innerHTML = `
                ...
                <div class="card-content">
                    ...
                    <div class="card-location">
                        ...
                        <a href="http://googleusercontent.com/maps.google.com/?q=${encodeURIComponent(event.address + ' ' + event.city)}" target="_blank">${event.address}, ${event.city}</a>
                    </div>
